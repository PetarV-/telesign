...
class KMeansPredictor():
    ...
    def __init__(self, n_clusters, bl_position=273):
        ...
        self.kmeans = KMeans(n_clusters=self.n_clusters, random_state=random.random())
    ...
    def black_listed_distribution(self):
        ...
        bl_num = len([bm for bm in bl_mask if bm == True])
        ...
        for i in range(len(bl_clusters)):
            ...
            print('Cluster {}: {} percent of all blacklisted'.format(i, perc))